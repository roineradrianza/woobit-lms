...
<head>
    ...
    <meta property="og:image" itemprop="image" content="<?php echo SITE_URL ?>/img/og-cover-2.jpg">
    ...
    <link
        ...
        rel="stylesheet">
    <link href="<?php echo SITE_URL ?>/css/material-design-icons.min.css" rel="stylesheet">
    <link href="<?php echo SITE_URL ?>/css/vuetify.min.css" rel="stylesheet">
    <link href="<?php echo SITE_URL ?>/css/app-v1.0.0.min.css" rel="stylesheet">
    ...
    <?php else: ?>
    <link href="<?php echo SITE_URL ?>/assets/css/<?php echo $style['name']; ?>.css" rel="stylesheet">
...
<body class="body-preload">
    <?php echo new Controller\Template('parts/preloader') ?>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo GOOGLE_APP_ID ?>"></script>
    <script>
    /*
    ...
    gtag('config', '<?php echo GOOGLE_APP_ID ?>');
    */
    </script>
    <?php endif ?>
    <script>
    <?php $id = (string) $_SESSION['user_id']; ?>
    var uid = "<?php echo Controller\Helper::encrypt($id);?>"
    const basic_info = {
    ...
    <script src="<?php echo SITE_URL ?>/js/preload.js"></script>
    <?php if (DEV_ENV) : ?>
    <script src="<?php echo SITE_URL ?>/js/vue.js"></script>
    <?php else: ?>
    <script src="<?php echo SITE_URL ?>/js/vue.pmin.js"></script>
    <?PHP endif ?>

    <script src="<?php echo SITE_URL ?>/js/components/vuetify.min.js"></script>
    <script src="<?php echo SITE_URL ?>/js/components/vue-resource.min.js"></script>
    <script src="<?php echo SITE_URL ?>/js/theme.js"></script>
    <script src="<?php echo SITE_URL ?>/js/setup.js"></script>
    ...
    <script
        src="<?php echo SITE_URL ?>/assets/js/<?php echo $script['name']; ?>.js<?php echo !empty($script['version']) ? "?v={$script['version']}" : '' ?>">
    </script>
    ...
    <?php if (isset($_SESSION['user_id'])): ?>
    <script src="<?php echo SITE_URL ?>/assets/js/notifications.min.js?v=v1.0.0"></script>
    <?php endif ?>
