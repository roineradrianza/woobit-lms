<v-container class="pt-16 pt-md-0 px-6 px-md-0">
    ...
    <p class="text-justify">
        ...
        data de 27 aprilie 2016 privind protecția persoanelor fizice în ceea ce
    ...
    <p class="text-justify">
        ...
        muncă, formare profesionala, situație familială, situație
        economico-financiară, date privind bunurile deținute,
        obișnuinte/preferințe/comportament, imagine, voce, preferințele personale
    ...
    <p class="text-justify">
        ...
        fi colectarea, înregistrarea, organizarea, structurarea, stocarea,
        adaptarea sau modificarea, extragerea, consultarea, utilizarea,
        transmiterea prin transmitere, diseminarea sau punerea la dispoziție în
    ...
    <ul type="disc">
        ...
        <p class="text-justify">
            ...
            personale, inclusiv, în anumite situații, codul numeric personal, în
            scopul de a ne îndeplini obligațiile impuse de către autoritățile
        ...
        <p class="text-justify">
            ...
            mai multe scopuri specifice. Astfel, dacă v-ați abonat în secțiunea de
            Newsletter, datele dumneavoastră cu caracter personal vor fi utilizate
            cu scopul de a vă transmite mesaje de marketing, oferte, știri,
            viitoare campanii, invitații la diverse evenimente. Datele
            dumneavoastră cu caracter personal urmează a fi șterse, atunci când
            anulați abonamentul din secțiunea de Newsletter. Vă puteți dezabona în
            orice moment prin intermediul link-ului atașat comunicărilor primite
    ...
    <p class="text-justify">
        ...
        site-urile web și/sau aplicațile și alte site-uri accesibile prin
    ...
    <p class="text-justify">
        ...
        să presteze servicii de stocare date de identificare a cardului, despre a
    ...
    <p class="text-justify">
        ...
        pagină securizată, unde înregistrarea fiecărui deținător de card se face
        prin atribuirea unui cod de autorizare pentru fiecare tranzacție online.
    ...
    <ol start="1" type="1">
        ...
        <p class="text-justify">
            ...
            o dispută sau o revendicare. Rețineți că este posibil să realizăm
            profilarea datelor, pe baza datelor pe care le colectăm de la dvs., în
            scopuri de analiză statistică și de marketing. Orice activitate de
            profilare va fi efectuată numai cu consimțământul dvs. prealabil și
            depunând toate eforturile pentru a vă asigura că toate datele pe care
            se bazează sunt corecte. Prin furnizarea oricăror date personale
            sunteți de acord în mod explicit că putem să-l folosim, pentru a
        ...
        <p class="text-justify">
            ...
            indicând acest lucru în etapa de rezervare. De asemenea, la orice
            comunicare online din partea noastră sau a partenerilor noștri de
            încredere, veți avea ocazia să indicați că nu mai doriți să primiți
    ...
    <p class="text-justify">
        ...
        dacă putem asigura anonimitatea datelor dvs. Personale, astfel încât
    ...
    <ol start="1" type="1">
        ...
        <p class="text-justify">
            ...
            conformitate cu reglementările și îndrumările locale. În acest sens,
            menționăm că datele prelucrate pentru acest scop vor fi șterse la <strong>5 </strong>ani după ultima
        ...
        <p class="text-justify">
            ...
            activă cu mărcile noastre), definite în conformitate cu reglementările
            și îndrumările locale. În acest sens, menționăm că datele stocate în
            bazele noastre de date pentru scopul comunicărilor de marketing direct
        ...
        <p class="text-justify">
            ...
            cumpărături sau cookie-urile pentru ID-uri de sesiune) și pentru o
            perioadă definită în conformitate cu reglementările și îndrumările
            locale. În acest sens, menționăm că datele prelucrate prin modulele
            cookies folosite pentru a furniza publicitate comportamentală online,
            pentru a ne personaliza serviciile pentru dumneavoastră și pentru a
            permite distribuirea conținutului nostru pe site-uri de socializare
            (butoane de distribuire destinate afișării site-ului), vor fi păstrate
            pentru o perioadă de maxim <strong>5 </strong>ani de la colectarea
    ...
    <p class="text-justify">
        ...
        acțiuni de acces neautorizat, utilizare necorespunzătoare sau transmitere,
        modificare neautorizată, distrugere sau pierdere accidentală. Toți
        angajații și colaboratorii Woobit, precum și orice terțe părți care
        acționează în numele și pe seama Woobit sunt obligați să respecte
    ...
    <p class="text-justify">
        ...
        sunt protejate cu ajutorul tehnologiei SSL (Secure Socket Layer). SSL este
    ...
    <p class="text-justify">
        ...
        operaționale de securitate adecvate, pentru a vă proteja datele personale,
    ...
    <p class="text-justify">
        ...
        date cu respectarea Regulamentului mai sus amintit, în virtutea asigurării
        oferirii unor servicii cât mai profesionale cu putință. Informațiile
        controlate de Woobit ar putea fi transferate, transmise sau stocate și
        prelucrate în UE sau în alte țări decât țara în care locuiți, în scopurile
        descrise în această politică. Aceste transferuri de date sunt necesare
        pentru a putea furniza servicii la cel mai înalt nivel, precum și a
        continua să vă furnizăm materialele noastre la cel mai bun nivel
        profesional. Utilizăm clauze contractuale standard aprobate de Comisia
        Europeană și ne bazăm pe deciziile privind caracterul adecvat emise de
        Comisia Europeană, cu privire la anumite țări, după caz, în ceea ce
    ...
    <ol start="1" type="1">
        <p class="text-justify">
            ...
            Daca veți mai avea nevoie de copii ale informațiilor deja furnizate,
            este posibil să percepem o taxă rezonabilă ținând cont de costurile
        ...
        <p class="text-justify">
            ...
            sunt incomplete. Dacă aveți un cont, poate fi mai ușor să vă corectați
        ...
        <p class="text-justify">
            ...
            – În unele cazuri, aveți dreptul de a obține ștergerea sau distrugerea
            Datelor dumneavoastră. Acesta nu este un drept absolut, deoarece uneori
        ...
        <p class="text-justify">
            ...
            dumneavoastră este limitată, astfel încât să putem păstra Datele, dar
            să nu le utilizăm sau să le procesăm. Acest drept se aplică în
            circumstanțe specifice prevăzute de Regulamentul general privind
    ...
    <ol start="1" type="1">
        <p class="text-justify">
            ...
            numai datelor pe care le-ați furnizat, atunci când procesarea se
        ...
        <p class="text-justify">
            ...
            – Aveți dreptul să depuneți o plângere în fața autorității de protecție
        ...
        <p class="text-justify">
            ...
            – Vă puteți dezabona sau renunța la comunicarea noastră de marketing
            direct în orice moment. Este mai ușor să faceți acest lucru dând clic
        ...
        <p class="text-justify">
            <strong>
                ...
                interesele legitime proprii sau ale unui terț
            </strong>
            – Vă puteți opune în orice moment prelucrării datelor dumneavoastră
            atunci când o astfel de prelucrare se bazează pe un interes legitim.
        </li>
        <p class="text-justify">
            ...
            pentru a accepta modulele cookie, dar puteți să le reglați ușor
    ...
    <ol start="1" type="1">
        <p class="text-justify">
            ...
            considerăm, cu bună-credință, că răspunsul impus de legile din
        ...
        <p class="text-justify">
            ...
            condițiilor sau politicilor noastre sau alte activități dăunătoare sau
            ilegale, pentru a ne proteja pe noi (inclusiv drepturile, bunurile sau
            materialele noastre), pe dumneavoastră și pe alții, inclusiv în cadrul
            investigațiilor sau al anchetelor autorităților de reglementare sau
            pentru a preveni decesul sau vătămarea corporală iminentă. De exemplu,
            dacă este relevant, furnizăm informații către și primim informații de
            la terți parteneri despre fiabilitatea contului dumneavoastră, pentru a
            preveni frauda, abuzul și alte activități dăunătoare în cadrul și în
    ...
    <p class="text-justify">
        ...
        guvernamentale, sau al unor investigații privind posibile încălcări ale
    ...
    <p class="text-justify">
        ...
        nu va putea fi ținută răspunzătoare pentru conținutul, publicitatea,
        bunurile, serviciile, software-ul, informațiile sau alte materiale
        disponibile pe sau prin intermediul acestor site-uri. Woobit nu va fi
        responsabil de pierderea datelor cu caracter personal, de orice efecte
