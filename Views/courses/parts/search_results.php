        ...
        <v-card :loading="loading" class="my-12 course-card"
            ...
            <v-card-text class="pb-md-10 pb-lg-5">
                ...
                <v-avatar class="teacher-course-avatar">
                    ...
                    <img src="<?php echo SITE_URL ?>/img/avatar-logo.png" width="20px" height="20px" alt="FL">
                    <?php else: ?>
                ...
                <?php if ($course['platform_owner']) : ?>
                <span class="subtitle-2 font-weight-bold">Woobit</span class="subtitle-2 text-primary">
                <?php else: ?>
