<v-col class="mb-n4" cols="12">
	<p class="subtitle-1 secondary--text font-weight-bold">Datos de la cuenta de PagoMovil a la que se realizó el pago:</p>
</v-col>
<v-col cols="4">
	<p class="body-1 primary--text">Documento de Identidad: <span class="font-weight-light black--text">{{ order.meta.document }}</span></p>
</v-col>
<v-col cols="4">
...
<v-col cols="4">
	<p class="body-1 primary--text">Número de Teléfono: <span class="font-weight-light black--text">{{ order.meta.telephone }}</span></p>
</v-col>
<v-col cols="4">
