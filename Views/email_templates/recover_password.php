          ...
          <div class='content' style='box-sizing: border-box; display: block; Margin: 0 auto; max-width: 580px; padding: 10px;'>
            ...
            <table class='main' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; background: #ffffff; border-radius: 3px;'>
              <td style="display: flex;">
                <img src='https://woobit.ro/img/woobit-logo.png' style="width:35%; max-width: 200px; margin:auto;"></img>                
              </td>
                  ...
                  <table border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;'>
                    <tr>
                      <td style='font-size: 16px; vertical-align: top;'>
                        <p>Ați solicitat recent să vă resetați parola, puteți continua făcând clic pe următorul link <a href="<?= SITE_URL ?>/password-reset/?code=<?= $data['reset_code'] ?>" style="color: #3d0235;"><?= SITE_URL ?>/password-reset?code=<?= $data['reset_code'] ?></a>. 
                        <br>
                        <br>
