...
<v-col cols="12" md="4">
  <label class="body-1 font-weight-thin pl-1">Número de Teléfono</label>
  <v-text-field type="text" name="telephone" v-model="payments.editedItem.meta.telephone" class="mt-3 fl-text-input" filled rounded dense></v-text-field>
</v-col>
